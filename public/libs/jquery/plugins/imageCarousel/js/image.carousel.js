...
function imageCarousel(){
    ...
    var aSort = [];
    var aPosition = [
        {width:300,height:320,top:0,left:352,zIndex:10},
        {width:216,height:212,top:56,left:148,zIndex:8},
        {width:160,height:140,top:92,left:0,zIndex:6},
        {width:96,height:60,top:132,left:148,zIndex:4},
        {width:66,height:20,top:172,left:232,zIndex:2},
        {width:66,height:20,top:172,left:708,zIndex:2},
        {width:96,height:60,top:132,left:770,zIndex:4},
        {width:160,height:140,top:92,left:844,zIndex:6},
        {width:216,height:212,top:56,left:250,zIndex:8}
    ]
    ...
    oSmall.onmouseout = oBut.onmouseout = function(){
     ...
     timer = setInterval(setInter,500);
    function setInter(){
        iNow++;
